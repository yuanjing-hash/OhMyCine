...
export function isAutoIndexableRawSourceType(type: DataSourceConfig['type']): type is Extract<RawFileSourceType, 'alist' | 'clouddrive2' | 'webdav' | 'local'> {
  return type === 'alist' || type === 'clouddrive2' || type === 'webdav' || type === 'local'
}
